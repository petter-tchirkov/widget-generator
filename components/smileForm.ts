        ...
        <span class="checkmark">
          <svg viewBox="0 0 24 24" width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <g id="SVGRepo_iconCarrier">
              <circle cx="12" cy="12" r="9.5" stroke="#222222" stroke-linecap="round"></circle>
              <path
              ...
              <path d="M17 8L14 10" stroke="#222222" stroke-linecap="round"></path>
              <path d="M7 8L10 10" stroke="#222222" stroke-linecap="round"></path>
          ...
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <g id="SVGRepo_iconCarrier">
              ...
              <path
                ...
                fill="#222222" stroke="#222222" stroke-linecap="round"></path>
              <path
          ...
          <svg viewBox="0 0 24 24" width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <g id="SVGRepo_iconCarrier">
              ...
              <path
                d="M8.20857 16.622C8.63044 16.2567 9.20751 15.9763 9.86133 15.7876C10.5191 15.5977 11.256 15.5 12 15.5C12.744 15.5 13.4809 15.5977 14.1387 15.7876C14.7925 15.9763 15.3696 16.2567 15.7914 16.622"
                stroke="#222222" stroke-linecap="round"></path>
              <circle cx="9" cy="10" r="1" fill="#222222" stroke="#222222" stroke-linecap="round"></circle>
              <circle cx="15" cy="10" r="1" fill="#222222" stroke="#222222" stroke-linecap="round"></circle>
            </g>
            </g>
          </svg>
        </span>
      ...
      <label class="smile love">
        ...
        <span class="checkmark">
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <g id="SVGRepo_iconCarrier">
              <circle cx="12" cy="12" r="9.5" stroke="#222222" stroke-linecap="round"></circle>
              <path d="M16 8L8 11" stroke="#222222" stroke-linecap="round"></path>
              <path d="M8 8L16 11" stroke="#222222" stroke-linecap="round"></path>
              <path
...
export const smileFormCss = `
    ...
    .angry input:checked~.checkmark svg {
      fill: red;
    }
    .sad input:checked~.checkmark svg {
      fill: orange;
    }
    .neutral input:checked~.checkmark svg {
      fill: yellow;
    }
    .happy input:checked~.checkmark svg {
      fill: lightgreen;
    }
    .love input:checked~.checkmark svg {
      fill: pink;
    }
`
